...
!  TEST MULTIFLUID VERSION: just using single fluid here to test development protocol
module ModVarIndexes
  ...
  character (len=*), parameter :: &
       NameEquation = &
       'MHD with electron pressure and hyperbolic cleaning->multifluid devel v1.0'
