...
module ModVarIndexes
  ...
  character (len=*), parameter :: &
       NameEquation = 'MultiFluid: H+, He2+, Hyp, and Pe DEVEL V1.2'
  ...
  character (len=4), parameter :: NameFluid_I(nFluid) = [ 'Hp  ', 'He2p' ]
  ...
  integer, parameter :: iRho_I(nFluid)   = [HpRho_,   He2pRho_]
  integer, parameter :: iRhoUx_I(nFluid) = [HpRhoUx_, He2pRhoUx_]
  integer, parameter :: iRhoUy_I(nFluid) = [HpRhoUy_, He2pRhoUy_]
  integer, parameter :: iRhoUz_I(nFluid) = [HpRhoUz_, He2pRhoUz_]
  integer, parameter :: iP_I(nFluid)     = [HpP_,     He2pP_]
